          ...
          <div className="row">
            ...
            <aside className="col-md-3">
              <nav className="list-group">
                ...
                <Link className="list-group-item active" to="/profile/orders"> My Orders </Link>
                ...
                <div className="table-responsive">
                  <table className="table table-hover">
                    <tbody>
                      <tr>
                        <td width="65">
                          <img src="/assets/images/items/1.jpg" className="img-xs border" alt="Product 1" />
                        </td>
                        <td>
                        ...
                        <td width="250">
                          ...
                          <div className="dropdown d-inline-block">
                            <a href="#" data-toggle="dropdown" className="dropdown-toggle btn btn-outline-secondary">
                              More
                            </a>
                      ...
                      <tr>
                        <td>
                          <img src="/assets/images/items/2.jpg" className="img-xs border" alt="Product 2" />
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img src="/assets/images/items/3.jpg" className="img-xs border" alt="Product 3" />
                        </td>
                        <td>
                          <p className="title mb-0">The name of the product goes here</p>
                          <var className="price text-muted">USD 145</var>
                        </td>
                        <td>Seller <br /> Walmart</td>
                        <td>
                          <a href="#" className="btn btn-outline-primary">Track order</a>
                          <div className="dropdown d-inline-block">
                            <a href="#" data-toggle="dropdown" className="dropdown-toggle btn btn-outline-secondary">
